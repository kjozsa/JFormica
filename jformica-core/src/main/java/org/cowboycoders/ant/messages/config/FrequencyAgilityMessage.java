...
public class FrequencyAgilityMessage extends ChannelMessage
{
	...
	private static DataElement[] additionalElements = new DataElement[]{
			DataElement.CHANNEL_FREQUENCY, DataElement.CHANNEL_FREQUENCY, DataElement.CHANNEL_FREQUENCY,
			};
	 ...
	 */
	public FrequencyAgilityMessage( Integer channelNo, Integer frequency1, Integer frequency2, Integer frequency3 )
	{
	...
	public FrequencyAgilityMessage( Integer frequency1, Integer frequency2, Integer frequency3 )
	{
