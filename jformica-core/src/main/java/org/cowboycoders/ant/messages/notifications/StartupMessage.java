...
public class StartupMessage extends StandardMessage {
    ...
    public boolean wasHardwareLineReset() {
        if ((getStandardPayload().get(0) & (1 << 0)) != 0) {
            return true;
        }
        return false;
    }
    ...
    public boolean wasWatchDogReset() {
        if ((getStandardPayload().get(0) & (1 << 1)) != 0) {
            return true;
        }
        return false;
    }
    ...
    public boolean wasCommandReset() {
        if ((getStandardPayload().get(0) & (1 << 5)) != 0) {
            return true;
        }
        return false;
    }
    ...
    public boolean wasSynchronousReset() {
        if ((getStandardPayload().get(0) & (1 << 6)) != 0) {
            return true;
        }
        return false;
    }
    ...
    public boolean wasSuspendReset() {
        if ((getStandardPayload().get(0) & (1 << 7)) != 0) {
            return true;
        }
        return false;
    }
