...
public class Constants {
    ...
    public enum DataElement {
        ...
        DEVICE_NUMBER(2), DEVICE_TYPE(1), TRANSMISSION_TYPE(1),

        RSSI_MEASUREMENT_TYPE(1), RSSI_VALUE(1), RSSI_THRESHOLD_CONFIG(1), RX_TIMESTAMP(2),

        FILLER_BYTE(1), EXTENDED_MESSAGE_FLAG(1),

        CHANNEL_TYPE(1), NETWORK_NUMBER(1), EXTENDED_ASSIGNMENT(1),
        ...
        LIST_SIZE(1, 4), INCLUDE_EXCLUDE_FLAG(1, 1),
        ...
        MAX_CHANNELS(1), MAX_NETWORKS(1), STANDARD_CAPABILITIES(1), ADVANCED_CAPABILITIES(1),
