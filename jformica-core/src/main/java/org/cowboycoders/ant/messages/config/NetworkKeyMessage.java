...
public class NetworkKeyMessage extends StandardMessage {
     ...
     */
    private static DataElement[] additionalElements = new DataElement[9];
    ...
    private void setNetworkKey(int[] networkKey) throws ValidationException {
        ValidationUtils.maxMinValidator(MIN_NETWORK_KEY_LENGTH,
                MAX_NETWORK_KEY_LENGTH,
                networkKey.length,
